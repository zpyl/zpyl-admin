            ...
            <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                ...
                <div id="toolbar">
                    <table>
                        <tr>
                            <td>
                                <span class="btn btn-primary" style="margin-right: 10px" data-toggle="modal" data-target="#addModal" onclick="btn_info()">宿舍详情</span>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                ...
                                <button title="查询" id="btnSearch" type="button" onclick="find()" >查询
                                </button>
                            </td>
                        </tr>
                    </table>
...
<script>
    ...
    $(function() {
        ...
        $('#myTab').bootstrapTable({
            url: '/bedroom/bedroom/list',        // 表格数据来源
        ...
        function btn_info() {
            ...
            if (select.length < 1) {
                ...
                window.location.href = "/bedroom/bedroom/studentInfo?bedroomId=" + select[0].bedroomId+"&hostelId=${hostel.hostelId}";
            }
        }
</script>
</html>
