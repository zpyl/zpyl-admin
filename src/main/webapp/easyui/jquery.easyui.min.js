    ...
    function _353(_354, _355, _356) {
        ...
        function _35b() {
            ...
            if (_355 == "east") {
                ...
                return {
                    resizeC: {width: _35e.width + _35f.width - 28},
                    expand: {left: cc.width() - _35f.width},
                    expandP: {top: _35e.top, left: cc.width() - 28, width: 28, height: _35e.height},
                    collapse: {left: cc.width(), top: _35e.top, height: _35e.height}
                };
            } else {
                if (_355 == "west") {
                    var _360 = _357["west"].panel("options");
                    return {
                        resizeC: {width: _35e.width + _360.width - 28, left: 28},
                        expand: {left: 0},
                        expandP: {left: 0, top: _35e.top, width: 28, height: _35e.height},
                        collapse: {left: -_360.width, top: _35e.top, height: _35e.height}
                    };
                } else {
                    if (_355 == "north") {
                        var hh = cc.height() - 28;
                        ...
                        return {
                            ...
                            collapse: {top: -_357["north"].panel("options").height, width: cc.width()}
                        };
                    } else {
                        if (_355 == "south") {
                            var hh = cc.height() - 28;
                            ...
                            return {
                                resizeC: {height: hh},
                                expand: {top: cc.height() - _357["south"].panel("options").height},
    ...
    function _361(_362, _363) {
        ...
        function _366() {
            ...
            if (_363 == "east" && _364.expandEast) {
                return {
                    collapse: {left: cc.width(), top: _368.top, height: _368.height},
                    expand: {left: cc.width() - _364["east"].panel("options").width}
                };
            } else {
                if (_363 == "west" && _364.expandWest) {
                    return {
                        collapse: {left: -_364["west"].panel("options").width, top: _368.top, height: _368.height},
                        expand: {left: 0}
                    };
                } else {
                    if (_363 == "north" && _364.expandNorth) {
                        return {
                            collapse: {top: -_364["north"].panel("options").height, width: cc.width()},
                            expand: {top: 0}
                        };
                    } else {
                        if (_363 == "south" && _364.expandSouth) {
                            return {
                                collapse: {top: cc.height(), width: cc.width()},
                                expand: {top: cc.height() - _364["south"].panel("options").height}
                            };
                        }
                    }
                }
...
(function ($) {
    ...
    $.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
        treeField: null, animate: false, singleSelect: true, view: _77a, loader: function (_7b1, _7b2, _7b3) {
            var opts = $(this).treegrid("options");
            if (!opts.url) {
                return false;
            }
