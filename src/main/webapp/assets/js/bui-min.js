 ...
 */this.seajs = {_seajs: this.seajs}, seajs.version = "1.3.0", seajs._util = {}, seajs._config = {
    ...
    var r = /.*(?=\/.*$)/, i = /([^:\/])\/\/+/g, s = /\.(?:css|js)$/, o = /^(.*?\w)(?:\/|$)/, c = {}, w = n.location,
    ...
    var n = document, r = n.head || n.getElementsByTagName("head")[0] || n.documentElement,
        i = r.getElementsByTagName("base")[0], s = /\.css(?:\?|$)/i, o = /loaded|complete|undefined/, u, a;
    ...
    var d = navigator.userAgent, v = Number(d.replace(/.*AppleWebKit\/(\d+)\..*/, "$1")) < 536,
...
define("bui/util", function () {
    ...
    var t = $.UA || function () {
        var t = $.browser, n = e(t.version),
            r = {ie: t.msie && n, webkit: t.webkit && n, opera: t.opera && n, mozilla: t.mozilla && n};
        return r
    }();
    return t
    ...
    return e.ATTRS = {
        ...
        __createDom: function () {
            ...
            var e = this, t = e.get("triggerEvent"), n = e.get("triggerHideEvent"), r = e.get("triggerCallback"),
                i = e.get("trigger"), s = e.get("delegateTigger"), o = $(i);
    ...
    return r.ATTRS = {
        ...
        isLoader: !0, _init: function () {
            ...
            var n = this, r = n.get("loadMask"), i = n.get("property"), s = n.get("callback"), o = n.get("renderer"),
                u = n.get("target");
    ...
    var t = e("bui/overlay/dialog"), n = BUI.prefix,
        ...
        }, {xclass: "message", priority: 0}), s = new i({icon: "info", title: ""}),
    ...
    var t = e("bui/common"), n = t.Component.UIBase, r = e("bui/list/domlist"), i = e("bui/list/keynav"),
        s = t.prefix + "list-item", o = t.Component.View.extend([r.View], {
    ...
    var t = BUI.Component, n = t.UIBase, r = t.View.extend([n.ListItemView], {}),
    ...
    var t = e("bui/overlay").Overlay, n = t.extend({
        bindUI: function () {
            ...
            r.on(e.get("triggerEvent"), function (t) {
                ...
                var n = e.get("curTrigger"), r = e.get("textField") || n, i = e.get("valueField"),
                    s = e.getSelectedValue(), o = !1;
                if (r) {
    ...
    var t = e("bui/common"), n = e("bui/toolbar").Bar, r = e("bui/form/fieldcontainer"), i = t.Component,
        s = r.View.extend({
    ...
    var t = e("bui/common"), n = t.Component, r = n.UIBase, i = t.prefix, s = i + "menu-item-open", o = "x-caret",
        u = i + "menu-item-collapsed", a = "data-id", f = n.View.extend([r.ListItemView, r.CollapseableView], {
    ...
    var t = e("bui/common"), n = e("bui/menu/menu"), r = t.Component, i = t.prefix + "menu-title", s = "menu-leaf",
        o = n.extend({
            initializer: function () {
                ...
                var n = this,
                    r = {xclass: "menu-item", elCls: "menu-leaf", tpl: '<a href="{href}"><em>{text}</em></a>'};
                return t.mix(r, e)
            }
    ...
    var t = e("bui/common"), n = t.Component, r = "tab-item-title", i = "tab-item-close", s = "tab-nav-actived",
        o = "tab-content", u = n.View.extend({
            renderUI: function () {
        ...
        }, {ATTRS: {tabContentContainer: {}, tabContentEl: {}, title: {}, href: {}}}), a = n.Controller.extend({
            createDom: function () {
    ...
    var t = e("bui/common"), n = e("bui/menu"), r = t.Component, i = "tab-nav-list", s = "arrow-left",
        o = "arrow-right", u = "m_close", a = 140, f = r.View.extend({
            renderUI: function () {
            ...
            addTab: function (e, n) {
                ...
                var t = this, n = t._getIndex(e), r = t.getActivedItem(), i = t._getItemByIndex(n - 1),
                ...
                var r = this, t = t || r.getContentElement(), i = t.parent().width(), n = n || t.position(),
                    s = r._getDistanceToBegin(e, n), o = s + a - i;
                return o
...
},
    {
        ...
        ,
            tpl:{
                view:!0, value
            :
                '<div class="tab-nav-bar"><s class="tab-nav-arrow arrow-left"></s><div class="tab-nav-wrapper"><div class="tab-nav-inner"><ul class="' + i + '"></ul></div></div><s class="tab-nav-arrow arrow-right"></s>' + "</div>" + '<div class="tab-content-container"></div>'
            }
        ,
            xview:{
                value:f
...
,
    ...
    var t = e("bui/common"), n = e("bui/tab/tabitem"), r = t.Component,
        i = n.View.extend({}, {xclass: "tab-panel-item-view"}), s = n.extend({
            renderUI: function () {
    ...
    var t = e("bui/common"), n = e("bui/tab/tab"), r = n.extend({
        initializer: function () {
            var e = this, n = e.get("children"), r = $(e.get("panelContainer")), i = e.get("panelCls"),
                s = i ? r.find("." + s) : r.children();
    ...
    var t = e("bui/toolbar/bar"), n = BUI.Component, r = n.UIBase.Bindable, i = BUI.prefix, s = "first", o = "prev",
        u = "next", a = "last", f = "skip", l = "totalPage", c = "curPage", h = "totalCount", p = t.extend([r], {
            initializer: function () {
        ...
        h = e("bui/toolbar"), p = t.Component, d = t.Date, w = p.Controller.extend({
            initializer: function () {
                var e = this, t = e.get("children"), n = new l, r = new c, i = e.get("footer") || e._createFooter(),
                    s = e.get("monthPicker") || e._createMonthPicker();
...
:
    ...
    var t = e("bui/common"), n = e("bui/mask"), r = t.UA, i = t.Component, s = e("bui/toolbar"), o = e("bui/list"),
        u = e("bui/grid/header"), a = e("bui/grid/column"), l = t.prefix, c = l + "grid-header-container",
        h = l + "grid-body", p = l + "grid-width", d = l + "grid-height", v = l + "grid-border", m = l + "grid-tbar",
        g = l + "grid-bbar", y = l + "grid-button-bar", b = l + "grid-strip", w = l + "grid-row",
        E = l + "grid-row-odd", x = l + "grid-row-even", T = l + "grid-row-first", N = l + "grid-cell",
        C = l + "grid-cell-inner", k = "grid-td-", L = l + "grid-cell-text", A = l + "grid-cell-empty", O = "17",
        M = l + "hidden", _ = "data-column-field", D = 2, P = 1, B = o.SimpleListView.extend({
            renderUI: function () {
                var e = this, t = e.get("el"), n = t.find("." + h);
                e.set("bodyEl", n), e._setTableTpl()
            }, getItemTpl: function (e, n) {
                var r = this, i = r._getColumns(), s = r.get("tbodyEl"), o = r.get("rowTpl"), u = n % 2 === 0 ? E : x,
                    a = [], f;
                ...
                var r = this, i = e.get("dataIndex"), s = e.get("cellTpl") || r.get("cellTextTpl"),
                    o = r._getCellInnerText(e, i, n);
    ...
    return i.ATTRS = {
        ...
        initializer: function (e) {
            ...
            var n = this, r = n.get("contentId"), i = $("#" + r).find("form"), s = n.get("editor"),
                o = t.merge(s, {contentId: r, form: {srcNode: i}});
    ...
    var n = e("bui/common"), r = e("bui/data"), i = "expanded", s = "loading", o = "checked", u = "partial-checked",
        a = {NONE: "none", ALL: "all", CUSTOM: "custom", ONLY_LEAF: "onlyLeaf"}, f = "x-tree-icon", l = "x-tree-elbow",
        c = "x-tree-show-line", h = l + "-", p = f + "-wraper", d = h + "line", v = h + "end", m = h + "empty",
        g = h + "expander", y = f + "-checkbox", b = g + "-end", w = function () {
        };
    return w.ATTRS = {
        store: {
            getter: function (e) {
